...
- [x] Five no-upload teaching packets from 6 to 300 Logons
...
2. **0:25-1:15 — Product.** Open **Try 5 examples**, compare the six-Logon linear chain with the 120-Logon conflict field, then inspect a contradiction.
